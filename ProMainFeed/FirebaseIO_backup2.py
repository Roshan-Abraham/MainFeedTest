...
class FireBase:
    ...
    def ProGet(self, id):
        ...
        if self.user_data["Working"] == True and self.user_data["Hiring"] == False and self.user_data["Investment"] == False:
            ...
            all_users = db.collection('ProUsers').where(u'isWorkGoals', u'==', False).where(u'isHiringGoals', u'==', True).where(u'isInvestmentGoals', u'==', False).limit(500)
        ...
        # Get : Investment // Working and Hiring empty
            ...
            all_users = db.collection('ProUsers').where(u'isWorkGoals', u'==', False).where(u'isHiringGoals', u'==', False).where(u'isInvestmentGoals', u'==', True).limit(500)
        ...
        # Get : Working // Hiring and Investment empty
            ...
            all_users = db.collection('ProUsers').where(u'isWorkGoals', u'==', True).where(u'isHiringGoals', u'==', False).where(u'isInvestmentGoals', u'==', False).limit(500)
        ...
        # Get : Working and Hiring // Investment empty
            ...
            all_users = db.collection('ProUsers').where(u'isWorkGoals', u'==', True).where(u'isHiringGoals', u'==', True).where(u'isInvestmentGoals', u'==', False).limit(500)
        ...
        # Get : Hiring and Investment// Working  empty
            ...
            all_users = db.collection('ProUsers').where(u'isWorkGoals', u'==', False).where(u'isHiringGoals', u'==', True).where(u'isInvestmentGoals', u'==', True).limit(500)
        ...
        # Get : Working and Investment // Hiring empty
            ...
            all_users = db.collection('ProUsers').where(u'isWorkGoals', u'==', True).where(u'isHiringGoals', u'==', False).where(u'isInvestmentGoals', u'==', True).limit(500)
        ...
        # Get : Hiring and Working and Investment// empty
            ...
            all_users = db.collection('ProUsers').where(u'isWorkGoals', u'==', True).where(u'isHiringGoals', u'==', True).where(u'isInvestmentGoals', u'==', True).limit(500)
